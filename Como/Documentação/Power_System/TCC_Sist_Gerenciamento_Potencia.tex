...
%\section{Objetivo}
	...
	O capítulo 2 apresenta um estudo histórico sobre os \textit{CubeSats}, como surgiram e o posicionamento do Brasil neste segmento. Além de toda bagagem teórica necessária para o desenvolvimento do projeto, como estudo do meio e das principais tecnologias aplicadas no \textit{CubeSat} do NSEE-IMT.
...
\section[Fotocélulas]{Fotocélulas} \label{Cap_Cell}
	...
	Na Figura \ref{Fig_cells}, é possível visualizar a diferença entre as tecnologias, no lado esquerdo está uma fotocélula com tecnologia espacial ao lado de uma fotocélula com tecnologia industrial.
...
\subsection[Carregador de bateria]{Carregador de bateria}
	...
	\begin{figure}[th]
		...
		\label{Fig_Temp_Carg}
		\centering
		\includegraphics[width=0.6\linewidth]{./figs/temp_carg}
	...
	\begin{figure}[th]
		...
		\label{Fig_Bat_Monit}
		\centering
		\includegraphics[width=0.6\linewidth]{./figs/bat_monit}
...
\subsection[Componentes passivos]{Componentes passivos}
	...
	\centering
		\begin{tabular}{p{1.5cm}|p{2cm}|p{1.2cm}}
			...
			\hline
			0,1 $ \Omega $ & SMD 2818 & 12 un.\\
			470 $ \Omega $ & SMD 0805 & 24 un.\\
			100 $ \Omega $ & SMD 0805 & 4 un.\\
			100 k$ \Omega $ & SMD 0805 & 4 un.\\
			10 k$ \Omega $ & SMD 0805 & 16 un.\\
			10,7 k$ \Omega $ & SMD 0805 & 4 un.\\
			115 k$ \Omega $ & SMD 0805 & 12 un.\\
			120 $ \Omega $ & SMD 0805 & 4 un.\\
			13,3 k$ \Omega $ & SMD 0805 & 4 un.\\
			17,4 k$ \Omega $ & SMD 0805 & 24 un.\\
			1 k$ \Omega $ & SMD 0805 & 25 un.\\
			1,5 k$ \Omega $ & SMD 0805 & 16 un.\\
			0,033 $ \Omega $ & SMD 2818 & 4 un.\\
			220 k$ \Omega $ & SMD 0805 & 4 un.\\
			22 k$ \Omega $ & SMD 0805 & 20 un.\\
			2,49 k$ \Omega $ & SMD 0805 & 64 un.\\
			2,2 k$ \Omega $ & SMD 0805 & 4 un.\\
			3,4 k$ \Omega $ & SMD 0805 & 4 un.\\
			33,2 k$ \Omega $ & SMD 0805 & 4 un.\\
			56,2 k$ \Omega $ & SMD 0805 & 8 un.\\
			680 k$ \Omega $ & SMD 0805 & 4 un.\\
			71,5 k$ \Omega $ & SMD 0805 & 8 un.\\
			8,45 k$ \Omega $ & SMD 0805 & 32 un.\\
		\end{tabular}	
	...
	\centering
		\begin{tabular}{p{2cm}|p{2cm}|p{1.3cm}}
			\textbf{Valor} & \textbf{\textit{Package}} & \textbf{Qtdd.}\\
			\hline
			3300 pF & SMD 0805 & 148 un.\\
			0,022 $\mu$F & SMD 0805 & 4 un.\\
			1000 pF & SMD 0805 & 16 un.\\
			100 nF & SMD 0805 & 12 un.\\
			10 nF & SMD 0805 & 4 un.\\
			10 $\mu$F & Case R & 4 un.\\
			1500 pF & SMD 0805 & 4 un.\\
			1 $\mu$F & SMD 0805 & 32 un.\\
			2,2 nF & SMD 0805 & 4 un.\\
			220 nF & SMD 0805 & 28 un.\\
			22 $\mu$F & Case C & 4 un.\\
			47 nF & SMD 0805 & 16 un.\\
			47 $\mu$F & Case C & 4 un.\\
		\end{tabular}	
