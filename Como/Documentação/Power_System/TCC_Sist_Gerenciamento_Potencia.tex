...
\section[Topologia]{Topologia}
	...
	\pagebreak
	cont...
	%Conforme pode ser visto na Figura \ref{Fig_Diag_Blocos_Final}, o projeto foi divido em três partes, sendo elas: placa de controle, placa do carregador e as placas das fotocélulas (+X, -X, +Y e -Y).
